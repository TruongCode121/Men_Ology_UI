...
const GridItemContent = () => {
  return (
    <section className="[&_.title]:uppercase [&_.title]:text-[rgba(255,255,255,0.65)] [&_.title]:text-[0.75rem] [&_.title]:lg:text-[0.875rem] absolute bottom-[2.31rem] sm:bottom-[4rem] lg:bottom-[7.88rem] lg:left-[6.25rem] tt_common_regular">
      <div
      ...
      >
        <div className="w-[13rem]">
          ...
          <div className="content leading-[1.40625rem] line-clamp-2 lg:pr-0 pr-[2rem]">
